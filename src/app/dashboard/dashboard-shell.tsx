...
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SidebarProvider defaultOpen={!focusMode}>
       ...
       <CommandMenu />
       <ShortcutsModal />
       <div className="flex min-h-screen w-full bg-background text-foreground relative transition-colors duration-500">
         <div className={cn(
         ...
         <div className="flex flex-col flex-1 transition-all duration-500 ease-in-out min-w-0">
           <Header />
           <main className={cn(
               "flex-1 p-4 md:p-6 overflow-auto transition-all duration-500",
